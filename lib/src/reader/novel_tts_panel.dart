...
abstract class NovelTtsDriver {
  ...
  /// [NovelSimulatedTtsDriver]-style timing or user taps.
...
/// completion through [NovelTtsDriver.onUtteranceComplete].
class NovelSimulatedTtsDriver extends NovelTtsDriver {
  NovelSimulatedTtsDriver({this.millisecondsPerParagraph = 2600});
...
/// )
/// ```
class NovelTtsPanel extends StatefulWidget {
  const NovelTtsPanel({
    super.key,
  ...
  @override
  State<NovelTtsPanel> createState() => _NovelTtsPanelState();
}

class _NovelTtsPanelState extends State<NovelTtsPanel> {
  ...
  @override
  void didUpdateWidget(covariant NovelTtsPanel oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        // ── Header ────────────────────────────────────────────────
        Padding(
          padding: const EdgeInsets.fromLTRB(NovelDimens.screenPadding, 8, 8, 8),
          child: Row(
            children: [
