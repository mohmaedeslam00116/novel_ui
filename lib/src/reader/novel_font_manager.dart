...
/// Runtime font-loading bridge — novel_ui's equivalent of the official
...
/// name in [NovelReaderSettings.fontFamily]:
///
/// ```dart
/// // From bundled assets:
/// await NovelFontManager.instance.loadFromAsset(
///   'WN Arabic Book', 'assets/fonts/NotoNaskhArabic.ttf');
///
/// // From bytes you fetched anywhere (network, file picker…):
/// await NovelFontManager.instance.load('WN Arabic Book', () => byteData);
///
...
class NovelFontManager {
  ...
  /// Shared singleton.
  static final NovelFontManager instance = NovelFontManager._();
