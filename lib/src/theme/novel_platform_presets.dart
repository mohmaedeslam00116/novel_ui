...
abstract final class NovelPlatformPresets {
  /// Wattpad — "Hero Orange" `#FF500A` on the official `--ds-*` token
  /// system (light ramp).
  static NovelColorScheme wattpad(BuildContext context) => const NovelColorScheme(
  ...
  static NovelColorScheme goodNovel(BuildContext context) => const NovelColorScheme(
    brightness: Brightness.light,
  ...
  static NovelColorScheme royalRoad(BuildContext context) => const NovelColorScheme(
    brightness: Brightness.light,
