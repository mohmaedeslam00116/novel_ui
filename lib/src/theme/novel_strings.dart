...
/// All user-facing labels used by novel_ui widgets.
///
/// Widgets read from `NovelTheme.of(context).strings`, so switching language
/// is one line — no codegen, no delegate:
///
/// ```dart
/// NovelThemeData.light().copyWith(strings: NovelStrings.ar())
/// ```
@immutable
class NovelStrings {
  const NovelStrings({
  ...
  /// English (default).
  static NovelStrings en() => const NovelStrings();

  /// Arabic — complete right-to-left preset.
  static NovelStrings ar() => const NovelStrings(
    seeAll: 'الكل',
    resume: 'متابعة',
    ongoing: 'مستمرة',
    completed: 'مكتملة',
  ...
  static NovelStrings lerp(NovelStrings a, NovelStrings b, double t) => t < 0.5 ? a : b;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is NovelStrings && runtimeType == other.runtimeType;
