...
/// )
/// ```
class NovelSearchSuggestions extends StatelessWidget {
    ...
    return ListView(
      ...
      children: [
        if (hotSearches.isNotEmpty) ...[
          ...
          const SizedBox(height: NovelDimens.md),
          Wrap(
            spacing: NovelDimens.sm,
            runSpacing: NovelDimens.sm,
            children: [
          ...
          const SizedBox(height: NovelDimens.xxl),
        ],
