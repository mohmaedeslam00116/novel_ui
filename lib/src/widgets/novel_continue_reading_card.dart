...
class NovelContinueReadingCard extends StatelessWidget {
  const NovelContinueReadingCard({
    super.key,
    required this.book,
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          borderRadius: BorderRadius.circular(NovelDimens.radiusLg),
          child: Container(
            padding: const EdgeInsets.all(NovelDimens.md),
            ...
            child: Row(
              children: [
                ...
                FilledButton(
                  ...
                  child: Text(NovelTheme.of(context).strings.resume),
                ),
              ],
            ),
          ),
...
class NovelSearchField extends StatelessWidget {
  const NovelSearchField({
    super.key,
    this.hintText,
    this.controller,
    this.focusNode,
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: hintText ?? NovelTheme.of(context).strings.searchHint,
...
class NovelPowerStoneButton extends StatefulWidget {
  const NovelPowerStoneButton({
    super.key,
    required this.count,
    this.voted = false,
    this.onVoted,
  ...
  @override
  State<NovelPowerStoneButton> createState() => _NovelPowerStoneButtonState();
}

class _NovelPowerStoneButtonState extends State<NovelPowerStoneButton>
    with SingleTickerProviderStateMixin {
  late bool _voted = widget.voted;
  late int _count = widget.count;
  late final AnimationController _pop = AnimationController(
    vsync: this,
    duration: NovelDimens.normal,
    value: 1,
  );
