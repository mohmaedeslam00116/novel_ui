...
/// NovelBannerCarousel(
///   banners: [
///     NovelBanner(title: 'New Season!', imageUrl: url, onTap: ...),
///   ],
/// )
/// ```
class NovelBannerCarousel extends StatefulWidget {
  const NovelBannerCarousel({
    super.key,
    required this.banners,
    this.height = 150,
    this.autoAdvance = true,
    this.autoAdvanceInterval = const Duration(seconds: 4),
    this.borderRadius = NovelDimens.radiusLg,
    this.aspectRatio = 16 / 9,
  });

  final List<NovelBanner> banners;
  final double height;
  ...
  @override
  State<NovelBannerCarousel> createState() => _NovelBannerCarouselState();
}

class _NovelBannerCarouselState extends State<NovelBannerCarousel> {
  ...
  @override
  void didUpdateWidget(covariant NovelBannerCarousel oldWidget) {
...
/// One carousel slide.
class NovelBanner {
  const NovelBanner({required this.title, this.imageUrl, this.tag, this.onTap});
