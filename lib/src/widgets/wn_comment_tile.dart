...
class WnFansRankBadge extends StatelessWidget {
  const WnFansRankBadge({super.key, required this.rank});
    ...
    if (color == null) {
      return Text(
        ...
        style: TextStyle(
          ...
          color: WnTheme.of(context).colorScheme.textTertiary,
        ),
      );
    }
    return Container(
...
class WnCommentTile extends StatelessWidget {
  const WnCommentTile({super.key, required WnComment comment})
    : _comment = comment;

  final WnComment _comment;

  @override
  Widget build(BuildContext context) {
    final cs = WnTheme.of(context).colorScheme;
    final t = WnTheme.of(context).components.commentTile;
    return InkWell(
                  ...
                  Row(
                    children: [
                      ...
                      if (_comment.level != null) ...[
                        ...
                        WnLevelBadge(level: _comment.level!),
                      ],
