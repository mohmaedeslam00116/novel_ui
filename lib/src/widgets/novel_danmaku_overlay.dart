...
/// Controller for feeding comments into a [NovelDanmakuOverlay].
///
/// ```dart
/// final danmaku = NovelDanmakuController();
/// ...
/// NovelDanmakuOverlay(controller: danmaku)
/// ...
/// danmaku.add('This panel!');
/// ```
class NovelDanmakuController {
...
/// Stack(children: [
///   pageContent,
///   Positioned.fill(child: IgnorePointer(child: NovelDanmakuOverlay(controller))),
/// ])
/// ```
class NovelDanmakuOverlay extends StatefulWidget {
  const NovelDanmakuOverlay({
    super.key,
  ...
  final NovelDanmakuController controller;
  ...
  @override
  State<NovelDanmakuOverlay> createState() => _NovelDanmakuOverlayState();
}

class _NovelDanmakuOverlayState extends State<NovelDanmakuOverlay>
  ...
  @override
  void didUpdateWidget(covariant NovelDanmakuOverlay oldWidget) {
