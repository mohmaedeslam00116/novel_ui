...
class NovelRankListItem extends StatelessWidget {
  const NovelRankListItem({
    super.key,
    required this.rank,
    required this.book,
    this.onTap,
    this.rankStyle = NovelRankStyle.plain,
  });

  /// Medal-styled row for the top three ranks.
  const NovelRankListItem.topThree({
    super.key,
    required this.rank,
    required this.book,
    this.onTap,
  ...
  final NovelRankStyle rankStyle;

  @override
  Widget build(BuildContext context) {
    final cs = NovelTheme.of(context).colorScheme;
    final t = NovelTheme.of(context).components.rankListItem;

    final Color rankColor;
    if (rank <= 3 && rankStyle == NovelRankStyle.topThree) {
          ...
          children: [
            SizedBox(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: rank <= 3 && rankStyle == NovelRankStyle.topThree
                      ? 20
                      : 15,
            ...
            NovelCoverView(
              ...
              title: book.title,
              author: book.author,
              width: t.coverWidth ?? NovelDimens.listCoverWidth * 0.86,
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      NovelRatingBar(value: book.score, size: 12),
                      const Spacer(),
                      Text(
...
enum NovelRankStyle { plain, topThree }
...
String novelCompactCount(int n) => _compactCount(n);
