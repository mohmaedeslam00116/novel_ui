...
class NovelCoverView extends StatelessWidget {
  const NovelCoverView({
    ...
    required this.title,
    this.author,
    this.width = NovelDimens.gridCoverWidth,
    this.aspectRatio = NovelDimens.coverAspectRatio,
    this.borderRadius = NovelDimens.coverRadius,
  ...
  static (Color, Color) _gradientFor(String seedText) {
    final pool = NovelColors.coverGradientPool;
    var hash = 0;
